  ...
  return (
    <div className='flex justify-between items-center py-4 border-b border-[#e2d8d857] px-3'>
      <div className='flex items-center space-x-2'>
        <img className='size-12 hover:transform hover:scale-110 duration-300 ease-out transition animate-pulse ' src={"/logo-a.jpg"} alt="" />
        <div>
      ...
      <div className='flex space-x-4 items-center'>
        <a target='_blank' href={'https://github.com/aryanpatel99'}>
          <svg className='hover:transform hover:scale-110  duration-300 ease-out' xmlns="http://www.w3.org/2000/svg" fill='#ffffff' x="0px" y="0px" width="1.6em" height="1.6em" viewBox="0 0 30 30">
