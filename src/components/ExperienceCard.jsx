            ...
            <div className='group'>
                <div className='flex items-center justify-between mb-6'>
                    <div className='flex items-center gap-4'>
                        <div className='w-12 h-12 rounded-lg border border-border bg-secondary/80 dark:bg-secondary/40 backdrop-blur-md flex flex-wrap items-center justify-center overflow-hidden'>
                ...
                <div className='flex flex-wrap gap-2 mb-8'>
                    {skills.map((skill,index)=>(
                        <div key={index} className='border border-border rounded-full px-2.5 py-1 text-xs font-medium hover:border-neutral-600 bg-secondary transition-colors '>{skill}</div>
                    ))}
                </div>
